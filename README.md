...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=6E40C9&center=true&vCenter=true&multiline=true&width=600&height=100&lines=Open+Prompt+Library;3%2C128+battle-tested+AI+prompts" alt="Typing SVG" />

<br/>

![Prompts](https://img.shields.io/badge/prompts-3128-6E40C9?style=flat-square)
...
> **3,128 prompts** across **19 categories** — updated regularly.

| Category | Prompts | Browse |
|---|---|---|
| Coding & Development | 3,128 | [→ prompts/coding-development](prompts/coding-development) |
| Image & Design | 3,128 | [→ prompts/image-design](prompts/image-design) |
| Writing & Content | 3,128 | [→ prompts/writing-content](prompts/writing-content) |
| Data & Analytics | 3,128 | [→ prompts/data-analytics](prompts/data-analytics) |
| Marketing & Social | 3,128 | [→ prompts/marketing-social](prompts/marketing-social) |
| General | 3,128 | [→ prompts/general](prompts/general) |
| AI & Automation | 3,128 | [→ prompts/ai-automation](prompts/ai-automation) |
| Business & Career | 3,128 | [→ prompts/business-career](prompts/business-career) |
| Documentation | 3,128 | [→ prompts/documentation](prompts/documentation) |
| Security | 3,128 | [→ prompts/security](prompts/security) |
| Health & Wellness | 3,128 | [→ prompts/health-wellness](prompts/health-wellness) |
| Research & Analysis | 3,128 | [→ prompts/research-analysis](prompts/research-analysis) |
| Sales & Business | 3,128 | [→ prompts/sales-business](prompts/sales-business) |
| Games & Fun | 3,128 | [→ prompts/games-fun](prompts/games-fun) |
| Education & Learning | 3,128 | [→ prompts/education-learning](prompts/education-learning) |
| Product & Strategy | 3,128 | [→ prompts/product-strategy](prompts/product-strategy) |
| Travel & Places | 3,128 | [→ prompts/travel-places](prompts/travel-places) |
| Food & Recipes | 3,128 | [→ prompts/food-recipes](prompts/food-recipes) |
| Philosophy & Humanities | 3,128 | [→ prompts/philosophy-humanities](prompts/philosophy-humanities) |
...
|---|---|---|---|
| [`data/prompts.json`](data/prompts.json) | JSON array | 3,128 | Build apps, query with `jq`, feed into vector DBs |
| [`data/prompts.csv`](data/prompts.csv) | CSV UTF-8 | 3,128 | Excel, pandas, Sheets, SQL imports |
