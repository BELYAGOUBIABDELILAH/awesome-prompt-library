...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=6E40C9&center=true&vCenter=true&multiline=true&width=600&height=100&lines=Open+Prompt+Library;3%2C390+battle-tested+AI+prompts" alt="Typing SVG" />

<br/>

![Prompts](https://img.shields.io/badge/prompts-3390-6E40C9?style=flat-square)
...
> **3,390 prompts** across **19 categories** — updated regularly.

| Category | Prompts | Browse |
|---|---|---|
| Coding & Development | 3,390 | [→ prompts/coding-development](prompts/coding-development) |
| Image & Design | 3,390 | [→ prompts/image-design](prompts/image-design) |
| Writing & Content | 3,390 | [→ prompts/writing-content](prompts/writing-content) |
| Data & Analytics | 3,390 | [→ prompts/data-analytics](prompts/data-analytics) |
| Marketing & Social | 3,390 | [→ prompts/marketing-social](prompts/marketing-social) |
| General | 3,390 | [→ prompts/general](prompts/general) |
| AI & Automation | 3,390 | [→ prompts/ai-automation](prompts/ai-automation) |
| Business & Career | 3,390 | [→ prompts/business-career](prompts/business-career) |
| Documentation | 3,390 | [→ prompts/documentation](prompts/documentation) |
| Security | 3,390 | [→ prompts/security](prompts/security) |
| Health & Wellness | 3,390 | [→ prompts/health-wellness](prompts/health-wellness) |
| Research & Analysis | 3,390 | [→ prompts/research-analysis](prompts/research-analysis) |
| Sales & Business | 3,390 | [→ prompts/sales-business](prompts/sales-business) |
| Games & Fun | 3,390 | [→ prompts/games-fun](prompts/games-fun) |
| Product & Strategy | 3,390 | [→ prompts/product-strategy](prompts/product-strategy) |
| Travel & Places | 3,390 | [→ prompts/travel-places](prompts/travel-places) |
| Food & Recipes | 3,390 | [→ prompts/food-recipes](prompts/food-recipes) |
| Philosophy & Humanities | 3,390 | [→ prompts/philosophy-humanities](prompts/philosophy-humanities) |
| Education & Learning | 3,390 | [→ prompts/education-learning](prompts/education-learning) |
...
|---|---|---|---|
| [`data/prompts.json`](data/prompts.json) | JSON array | 3,390 | Build apps, query with `jq`, feed into vector DBs |
| [`data/prompts.csv`](data/prompts.csv) | CSV UTF-8 | 3,390 | Excel, pandas, Sheets, SQL imports |
