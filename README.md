...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=6E40C9&center=true&vCenter=true&multiline=true&width=600&height=100&lines=Open+Prompt+Library;3%2C412+battle-tested+AI+prompts" alt="Typing SVG" />

<br/>

![Prompts](https://img.shields.io/badge/prompts-3412-6E40C9?style=flat-square)
...
> **3,412 prompts** across **19 categories** — updated regularly.

| Category | Prompts | Browse |
|---|---|---|
| Coding & Development | 3,412 | [→ prompts/coding-development](prompts/coding-development) |
| Image & Design | 3,412 | [→ prompts/image-design](prompts/image-design) |
| Writing & Content | 3,412 | [→ prompts/writing-content](prompts/writing-content) |
| Data & Analytics | 3,412 | [→ prompts/data-analytics](prompts/data-analytics) |
| Marketing & Social | 3,412 | [→ prompts/marketing-social](prompts/marketing-social) |
| General | 3,412 | [→ prompts/general](prompts/general) |
| AI & Automation | 3,412 | [→ prompts/ai-automation](prompts/ai-automation) |
| Business & Career | 3,412 | [→ prompts/business-career](prompts/business-career) |
| Documentation | 3,412 | [→ prompts/documentation](prompts/documentation) |
| Security | 3,412 | [→ prompts/security](prompts/security) |
| Health & Wellness | 3,412 | [→ prompts/health-wellness](prompts/health-wellness) |
| Research & Analysis | 3,412 | [→ prompts/research-analysis](prompts/research-analysis) |
| Sales & Business | 3,412 | [→ prompts/sales-business](prompts/sales-business) |
| Games & Fun | 3,412 | [→ prompts/games-fun](prompts/games-fun) |
| Product & Strategy | 3,412 | [→ prompts/product-strategy](prompts/product-strategy) |
| Travel & Places | 3,412 | [→ prompts/travel-places](prompts/travel-places) |
| Philosophy & Humanities | 3,412 | [→ prompts/philosophy-humanities](prompts/philosophy-humanities) |
| Food & Recipes | 3,412 | [→ prompts/food-recipes](prompts/food-recipes) |
| Education & Learning | 3,412 | [→ prompts/education-learning](prompts/education-learning) |
...
|---|---|---|---|
| [`data/prompts.json`](data/prompts.json) | JSON array | 3,412 | Build apps, query with `jq`, feed into vector DBs |
| [`data/prompts.csv`](data/prompts.csv) | CSV UTF-8 | 3,412 | Excel, pandas, Sheets, SQL imports |
